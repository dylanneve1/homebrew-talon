...
Homebrew tap for [Talon](https://github.com/thefalconry/talon) — a
...
(equivalent to `brew tap thefalconry/talon && brew install talon`)
...
[Talon release](https://github.com/thefalconry/talon/releases) and pins its
